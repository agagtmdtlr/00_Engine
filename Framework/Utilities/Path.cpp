...
const WCHAR* Path::ImageFilter = L"Image\0*.png;*.bmp;*.jpg;*.hdr;*.dds";
const WCHAR* Path::BinModelFilter = L"Binary Model\0*.model;*.static;*.mesh";
const WCHAR* Path::FbxModelFilter = L"Fbx Model\0*.fbx;*.obj\0";
const WCHAR* Path::ShaderFilter = L"HLSL file\0*.fx;*.fxo";
const WCHAR* Path::MaterialFilter = L"Material file\0*.material;*.materialpbr";
const WCHAR* Path::ClipFilter = L"Clip file\0*.clip";
