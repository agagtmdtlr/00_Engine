...
ModelAnimator::~ModelAnimator()
{
	...
	SafeDelete(instanceBuffer2); // Color
...
void ModelAnimator::UpdateBlendUpdate(UINT index)
{
...
void ModelAnimator::CreateClipTransform(UINT index) // index의 clip에 해당되는 본의 transform을 생성한다.
{
